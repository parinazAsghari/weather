              ...
              children: [
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('\u2022 اگر خودرو شما به دلیل نقص فنی یا غیر فنی ( تصادف ) متوقف گردد، به صورت رایگان به نزدیکترین نمایندگی مجاز سایپا یا پارکینگ حمل خواهد شد.', textAlign: TextAlign.justify),
                      Text(
                      ...
                      Text('\u2022 از دیگر مزایای این خدمت : تعویض لاستیک پنچر در صورت وجود زاپاس سالم به صورت رایگان می باشد. تمامی اشتراکها از ساعت 24 تاریخ خرید به مدت یکسال (365 روز) فعال می گردد.', textAlign: TextAlign.justify),
                    ],
                  ),
                ),
              ],
