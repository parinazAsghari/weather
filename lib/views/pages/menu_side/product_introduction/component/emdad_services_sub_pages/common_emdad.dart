              ...
              children: [
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('\u2022 با خرید این اشتراک میتوانید دو خودروی سواری را تحت پوشش خدمات امدادی ذیل قرار دهید.'),
                      ...
                      Text('\u2022 اگر خودرو شما به دلیل نقص فنی متوقف گردد، به صورت رایگان به نزدیکترین نمایندگی مجاز مرتبط با آن خودرو یا پارکینگ منتقل خواهد گردید (مشمول کلیه خودروهای سواری).'),
