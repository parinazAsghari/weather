              ...
              children: [
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('\u2022 خدمات الزامی به خدماتی اطلاق می گردد که خودروساز در ازای خرید خودرو نو به صورت رایگان به دارندگان گروه خودرو سازی سایپا اهداء می نماید.'),
                      Text('\u2022 اگر خودرو شما به دلیل نقص فنی دچار توقف گردد، به صورت رایگان به نزدیکترین نمایندگی مجاز سایپا حمل خواهد شد.'),
