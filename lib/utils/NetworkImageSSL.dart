...
class NetworkImageSSL extends ImageProvider<NetworkImageSSL> {
  ...
  @override ImageStreamCompleter load(NetworkImageSSL key,Function function) {
    return new MultiFrameImageStreamCompleter( codec: _loadAsync(key), scale: key.scale);
  }
